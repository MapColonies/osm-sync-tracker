...
*/}}
{{- define "osm-sync-tracker.fullname" -}}
...
Common labels
*/}}
{{- define "osm-sync-tracker.labels" -}}
osm-sync-tracker.sh/chart: {{ include "osm-sync-tracker.chart" . }}
{{ include "osm-sync-tracker.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "osm-sync-tracker.selectorLabels" -}}
...
*/}}
{{- define "osm-sync-tracker.cloudProviderImagePullSecretName" -}}
