...
export class initialMigration1621858416252 implements MigrationInterface {
  name = 'initialMigration1621858416252';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "osm_sync_tracker"."file" ("file_id" uuid NOT NULL, "sync_id" uuid NOT NULL, "start_date" TIMESTAMP NOT NULL, "end_date" TIMESTAMP, "status" "osm_sync_tracker"."file_status_enum" NOT NULL DEFAULT 'inprogress', "total_entities" integer, CONSTRAINT "PK_17d33ab8699706c2b9edcd29340" PRIMARY KEY ("file_id"))`
    );
    ...
    await queryRunner.query(
      `CREATE TABLE "osm_sync_tracker"."changeset" ("changeset_id" uuid NOT NULL, "osm_id" integer, CONSTRAINT "PK_93369eee06978180af05a101c3e" PRIMARY KEY ("changeset_id"))`
    );
    await queryRunner.query(
